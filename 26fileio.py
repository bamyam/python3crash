...
with open('member.data', 'w', encoding='utf-8') as f:
    f.write(data)

# 파일에 데이터 누적시켜 저장하기
# 파일쓰기모드를 a라고 지정하면
# 이전에 저장한 내용에 새로운 내용을 추가해서 저장함
with open('member.data', 'a', encoding='utf-8') as f:
    f.write(data+'\n')
...
sjs = f'{name},{kor},{eng},{mat}'


with open('sungjuk.csv', 'w', encoding='utf-8') as f:
    f.write(sjs)
