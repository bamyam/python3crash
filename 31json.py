...
# csv 표기법
# userid, passwd, email
# abc123, 987xyz, abc123@987xyz.com
...
# json 객체 생성 2 - OrderdDict 이용
# python의 dict보다 효율적으로 dict 객체 생성 가능
# Ordeddict에서는 순서가 정렬되서 나오며,
person = OrderedDict()
person['name'] = '혜교'
...
# 한글 출력을 위해서는 아스키코드로 바꾸지 못하도록
# ensure_ascii를 False로 바꿔줘야 함
print(obj)
