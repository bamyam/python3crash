...
print("저 청년의 이름은", name, "이고, 나이는", age,"세일세")
...
name = 'Seungjae Seo"
age = 42
email = 'bamyam10@naver.com'
isMarried = TRUE
hadMoney = 245,000
regdate = '2023-12-19 16:15:35'

#파이썬 자료형 - 정수, 실수, 문자, 블리얼(boolean)
#정수 자료형 - 소숫점 이하의 값이 없는 수
int1 = 123
int2 = 0b01010101 # 2진수
print(int1, int2, bin(int2))

#실수 자료형 - 소숫점 이하의 값이 있는 수
...
# 문자열은 ''나 ""를 이용해서 정의 가능 - ''를 추천
#여러 줄 문자열(텍스트)을 작성할 때는  ''' '''를 사용
str1 = 'Hello world'
str2 = 'Hello, \nworld'
str3 = 'Hello \
